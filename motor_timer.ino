...
NexButton decremento1 = NexButton(config, 10, "b0");
NexButton incremento1 = NexButton(config, 11, "b1");
NexText vazao1_text = NexText(config, 8, "t9");
NexButton habilita_seringa1 = NexButton(config, 24, "b4");

NexButton incremento2 = NexButton(config, 13, "b6");
NexButton decremento2 = NexButton(config, 12, "b5");
